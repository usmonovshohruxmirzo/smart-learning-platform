...
<template>
  <div class="min-h-screen bg-gray-100 flex flex-col">
        ...
        <nav class="flex flex-col gap-2">
          <div class="mb-2">
            ...
            <router-link
              ...
              class="flex items-center gap-2 px-3 py-2 rounded-lg text-blue-600 bg-blue-50 font-semibold"
    ...
    >
      ...
      <router-link
        to="/dashboard/courses"
        class="flex flex-col items-center justify-center flex-1 h-full text-gray-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
        active-class="text-blue-700"
        aria-label="Courses"
      >
        <font-awesome-icon :icon="['fas', 'book-open']" class="text-2xl mb-1" aria-hidden="true" />
