  ...
  <div class="w-full max-w-xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow p-6 flex flex-col items-center">
      <img
        ...
        alt="Avatar"
      />
      <h2 class="font-semibold text-lg mb-1 text-black">John Doe</h2>
      <p class="text-gray-500 mb-4">john.doe@email.com</p>
      <button
        class="px-4 py-2 rounded-lg bg-blue-600 text-white font-semibold hover:bg-blue-700 transition mb-2"
      >
        Update Avatar
      </button>
      <button
